...
function level6(){
    ...
    let random = Math.floor(Math.random() * 5);
        ...
        if (questionArea.innerText === questionsLvl6[0]){
            option1Box.innerText = l6Q1Answers[0]; // right
            ...
            option4Box.innerText = l6Q2Answers[3]; // right 
        }
        else if (questionArea.innerText === questionsLvl6[2]){
            option1Box.innerText = l6Q3Answers[0]; // right
            ...
            option3Box.innerText = l6Q4Answers[2]; // right
            ...
            option4Box.innerText = l6Q5Answers[3]; // right
        }
}
...
function selectOption1() {
    ...
    else if (questionArea.innerText === questionsLvl2[0]){ //lvl 2
        alert("Wrong");
    }
    else if (questionArea.innerText === questionsLvl2[1]){
        level3();
    ...
    else if (questionArea.innerText === questionsLvl3[0]){ //lvl 3
        alert("Wrong");
    }
    else if (questionArea.innerText === questionsLvl3[1]){
        alert("Wrong");
    ...
    else if (questionArea.innerText === questionsLvl4[0]){ //option 1 lvl 4
        level5();
        setMoneyWhite();
    ...
    else if (questionArea.innerText === questionsLvl5[0]){ //option 1 lvl 5
        level6();
        setMoneyWhite();
    ...
    else if (questionArea.innerText === questionsLvl6[0]){ //option 1 lvl 6
        alert("Wrong");
    }
    else if (questionArea.innerText === questionsLvl6[1]){
        level7();
...
function selectOption2() {
    ...
    else if (questionArea.innerText === questionsLvl4[0]){ //lvl 4
        alert("Wrong");
    }
    else if (questionArea.innerText === questionsLvl4[1]){
        alert("wrong");
    ...
    else if (questionArea.innerText === questionsLvl5[0]){ //lvl 5
        alert("Wrong");
    }
    else if (questionArea.innerText === questionsLvl5[1]){
        alert("wrong");
    ...
    else if (questionArea.innerText === questionsLvl6[0]){ //op 2 lvl 6
        alert("Wrong");
    }
    else if (questionArea.innerText === questionsLvl6[1]){
        alert("wrong");
...
function selectOption3() {
    ...
    else if (questionArea.innerText === questionsLvl6[0]){ //op 3 lvl 6
        alert("wrong");
    }
    else if (questionArea.innerText === questionsLvl6[1]){
        alert("wrong");
...
function selectOption4() {
    ...
    else if (questionArea.innerText === questionsLvl5[0]){ //op 4 lvl 5
        alert("wrong");
    }
    else if (questionArea.innerText === questionsLvl5[1]){
        level6();
    ...
    else if (questionArea.innerText === questionsLvl6[0]){ //op 4 lvl 6
        level7();
        setMoneyWhite();
        moneylvl6.style.color = "green";
        alert("correct");
